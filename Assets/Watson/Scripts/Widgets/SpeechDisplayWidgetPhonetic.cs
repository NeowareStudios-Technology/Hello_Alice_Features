    ...
    private void OnSpeechInput(Data data)
    {
      ...
      if (connected == true)
      {
        ...
        if (b == true)
        {
          ...
          GameObject.Find("Smodel").GetComponent<Renderer>().materials[0].color = Color.green;
          GameObject.Find("Amodel").GetComponent<Renderer>().materials[0].color = Color.green;
          GameObject.Find("Tmodel").GetComponent<Renderer>().materials[0].color = Color.green;
